...
# TODO: spec uncertain — the GitHub Copilot Workspace / Copilot Chat skill
# trigger schema is still evolving (as of 2026-04). The structure below is a
# best-effort match for the documented "pre-tool-use" + "keyword" hooks; adjust
# field names once the spec stabilises.
trigger:
  pre-tool-use:
    - "git push"
    - "git push --force"
...
# gospelo-identity Skill (GitHub Copilot)
...
Placement of this skill file depends on the Copilot variant:

- **GitHub Copilot Workspace**: drop into the project's Copilot skills
  directory (path TBD per Copilot release notes).
- **GitHub Copilot Chat (custom instructions)**: paste the body of this file
  into the workspace-level custom instructions.
